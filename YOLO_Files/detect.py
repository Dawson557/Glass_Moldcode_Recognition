...
def detect(
    ...
    #colors have been set manually to allow a certain familiarity with them
    colors = [[215,5,5], [215,150,5], [137,214,4], [4,214,207], [4,57,214],
        [109,4,214], [214,4,179], [220,220,220], [0,0,0], [185,116,120]]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default=r'C:\Users\admin\Desktop\Moldcode_Network\YOLO_Files\bottles_yolov3.cfg', help='cfg file path')
    # parser.add_argument('--data-cfg', type=str, default='data/coco_64img.data', help='coco.data file path')
    parser.add_argument('--data-cfg', type=str, default=r'C:\Users\admin\Desktop\Moldcode_Network\YOLO_Files\bottles.data', help='bottles.data file path')
    parser.add_argument('--weights', type=str, default=r'C:\Users\admin\Desktop\Moldcode_Network\weights\recogn_weights_01.pt', help='path to weights file')
    parser.add_argument('--images', type=str, default=r'C:\Users\admin\Desktop\Moldcode_Network\Bottle_Dataset\rotated_test', help='path to images')
