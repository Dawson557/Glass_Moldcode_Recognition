...
def test(
    ...
    for batch_i, (imgs, targets, paths, shapes, _) in enumerate(tqdm(dataloader, desc='Computing mAP')):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'C:\Users\admin\Desktop\Tests\yolov3\weights\latest.pt', help='path to weights file')
